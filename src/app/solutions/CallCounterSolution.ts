...
export class CallCounterSolution implements ISolution {
    //#region SolutionOne
    qArray: any = [];
    SolutionOne(input: number): number {
        this.qArray.push(input);
        while (this.qArray[0] < input - 3000) {
            this.qArray.shift();
        }
    ...
    Main() : void {
        ...
        console.log(this.SolutionOne(3002));


        console.log(this.SolutionOne(7000));
    }
}
